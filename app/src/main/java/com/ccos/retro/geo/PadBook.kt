...
object PadBook {
    ...
    private val aliases = listOf(
        ...
        "shar" to "satish dhawan",
        "boca chica" to "starbase",
        "guiana" to "kourou",
        "jslc" to "jiuquan",
        "jiuquan" to "jiuquan satellite",
        "xslc" to "xichang",
        "xichang" to "xichang satellite",
        "tslc" to "taiyuan",
        "taiyuan" to "taiyuan satellite",
        "wslc" to "wenchang",
        "wenchang" to "wenchang space",
        "haiyang" to "haiyang oriental",
        "tanegashima" to "tanegashima",
        "mahia" to "mahia",
        "wallops" to "wallops",
        "baikonur" to "baikonur"
    )
